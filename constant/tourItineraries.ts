export const itineraries = {
    ...
    itinerary: [
      {
        day: "Day 1",
        activity:
          "• Departure from Prayagraj – Early morning departure for a peaceful and hassle-free darshan.",
      },
      {
        day: "Day 1",
        activity:
          "• Kashi Vishwanath Temple Darshan – Seek blessings at one of the 12 Jyotirlingas.",
      },
      {
        day: "Day 1",
        activity:
          "• Annapurna Devi Temple Visit – Offer prayers to Goddess Annapurna.",
      },
      {
        day: "Day 1",
        activity:
          "• Vishalakshi Temple – A revered Shakti Peeth dedicated to Goddess Vishalakshi.",
      },
      {
        day: "Day 1",
        activity:
          "• Kal Bhairav Temple Visit – Pay homage to Lord Kal Bhairav, the guardian deity of Varanasi.",
      },
      {
        day: "Day 1",
        activity:
          "• Breakfast Break (Self-Paid) – Stop at a recommended restaurant.",
      },
      {
        day: "Day 1",
        activity:
          "• Boat Ride at Dashashwamedh Ghat – Experience the mystical beauty of the Ganges.",
      },
      {
        day: "Day 1",
        activity:
          "• Sankat Mochan Hanuman Temple Visit – Seek blessings from Lord Hanuman.",
      },
      {
        day: "Day 1",
        activity:
          "• Lunch Break (Self-Paid) – Enjoy a traditional vegetarian meal.",
      },
      {
        day: "Day 1",
      ...
      },
      {
        day: "Day 1",
        activity:
          "• Ganga Aarti at Dashashwamedh Ghat – Witness the spectacular evening aarti.",
      },
      {
        day: "Day 1",
        activity:
    ...
    itinerary: [
      {
        day: "Day 1",
        activity:
          "• Departure from Prayagraj – Early morning journey to maximize your spiritual experience.",
      },
      {
        day: "Day 1",
        activity:
          "• Sacred Snan at Ram Ki Paidi – Take a holy dip in the Sarayu River to cleanse your soul.",
      },
      {
        day: "Day 1",
        activity:
          "• Hanuman Garhi Darshan – Seek blessings from Lord Hanuman before visiting Ram Janmabhoomi.",
      },
      {
        day: "Day 1",
        activity:
          "• Ram Janmabhoomi Temple – Feel the divine presence at the birthplace of Lord Ram.",
      },
      {
        day: "Day 1",
        activity:
          "• Breakfast Break (Self-Paid) – Enjoy a delicious meal at a local restaurant.",
      },
      {
        day: "Day 1",
        activity:
          "• Kanak Bhavan Visit – A stunning temple gifted to Goddess Sita as a wedding present.",
      },
      {
        day: "Day 1",
        activity:
          "• Dashrath Mahal – Explore the royal palace of King Dashrath, where Lord Ram spent his childhood.",
      },
      {
        day: "Day 1",
        activity:
          "• Lunch Break (Self-Paid) – Savor a traditional vegetarian meal at a recommended eatery.",
      },
      {
        day: "Day 1",
        activity: "• Free Time for Shopping & Exploration (If time permits).",
      },
      {
        day: "Day 1",
        activity:
          "• Sarayu Aarti in the Evening – Witness the peaceful evening aarti by the Sarayu River.",
      },
      {
        day: "Day 1",
        activity:
  ...
  vindhyachal: {
    ...
    itinerary: [
      { day: "Day 1", activity: "• Afternoon Departure from Prayagraj" },
      { day: "Day 1", activity: "• Kali Khoh Temple Darshan" },
      { day: "Day 1", activity: "• Visit to Maa Ashtabhuja Temple" },
      { day: "Day 1", activity: "• Darshan at Vindhyavasini Mata Temple" },
  ...
  prayagraj: {
    ...
    highlights: [
      ...
      "Special Assistance for Elderly Devotees – We ensure a smooth and easy darshan experience",
      "Flexible Itinerary – Free time for shopping and exploring at your own pace",
      "Pay on Arrival – No advance payment required, book with confidence",
    ],
    itinerary: [
      {
        day: "Day 1",
        activity:
          "• Pickup from Prayagraj Airport/Railway Station – Our driver will greet you upon arrival and take you to your hotel for a refreshing start",
      },
      {
        day: "Day 1",
        activity:
          "• Check-in & Breakfast at the Hotel – Freshen up and enjoy a complimentary breakfast before heading out for the divine journey",
      },
      {
        day: "Day 1",
        activity:
          "• Triveni Snan & Boat Ride at Sangam – Experience the sacred confluence of the Ganga, Yamuna, and Saraswati rivers",
      },
      {
        day: "Day 1",
        activity:
          "• Bade Hanuman Ji Temple Darshan – Seek blessings at this one-of-a-kind temple, home to a reclining idol of Lord Hanuman",
      },
      {
        day: "Day 1",
        activity:
          "• Shankar Viman Mandapam – A magnificent South Indian-style temple dedicated to Lord Shiva",
      },
      {
        day: "Day 1",
        activity:
          "• Lunch & Midday Rest at Hotel – Enjoy a delicious vegetarian meal (Self-Paid) and rest before continuing your exploration",
      },
      {
        day: "Day 1",
        activity:
          "• Alopi Devi Shakti Peeth – Visit this sacred Shakti Peeth, where it is believed that the last part of Goddess Sati fell",
      },
      {
        day: "Day 1",
        activity:
          "• Nag Vasuki Temple – Seek blessings at this temple dedicated to Lord Vasuki (King of Serpents)",
      },
      {
        day: "Day 1",
        activity:
          "• Evening at Saraswati Ghat – Experience serenity by the river as you witness a breathtaking sunset over the Yamuna",
      },
      {
        day: "Day 1",
        activity:
          "• Free Time for Shopping & Local Exploration – Stroll through the local markets for spiritual souvenirs",
      },
      {
        day: "Day 1",
        activity:
          "• Dinner at a Partner Restaurant (Self-Paid) – End your day with a delicious meal of your choice",
      },
      {
        day: "Day 1",
        activity:
  ...
  "prayagraj-varanasi": {
    ...
    routeOverview: ["Day 1: Prayagraj Arrival, Darshan & Stay.","Day 2: Varanasi Darshan and departure"],
    highlights: [
    ...
    itinerary: [
      { day: "Day 1", activity: "• Morning Arrival & Briefing" ,},
      {
        day: "Day 1",
        activity:
          "• Pickup Assistance (Optional, Chargeable) – Pickup from anywhere in Prayagraj, complete booking formalities at branch office.",
      },
      {
        day: "Day 1",
        activity:
          "• Hotel Check-in & Breakfast – Freshen up and enjoy a complimentary breakfast.",
      },
      {
        day: "Day 1",
        activity:
          "• Triveni Sangam Snan & Boat Ride – Holy dip & optional pooja services available.",
      },
      {
        day: "Day 1",
        activity:
          "• Bade Hanuman Ji Temple Darshan – Seek blessings at the reclining Hanuman temple.",
      },
      {
        day: "Day 1",
        activity:
          "• Shankar Viman Mandapam – Visit the beautiful South Indian-style temple.",
      },
      {
        day: "Day 1",
        activity: "• Evening Exploration: Alopi Devi Temple & Shopping.",
      },
      {
        day: "Day 1",
        activity: "• Dinner at a recommended restaurant (Self-Paid).",
      },
      {
        day: "Day 1",
        activity: "• Late-Night Departure for Varanasi (Overnight Journey).",
      },

      { day: "Day 2", activity: "• Early Morning Arrival in Varanasi" },
      { day: "Day 2", activity: "• Kashi Vishwanath Temple Darshan." },
      { day: "Day 2", activity: "• Visit Annapurna Devi Temple." },
      { day: "Day 2", activity: "• Visit Vishalakshi Temple." },
      { day: "Day 2", activity: "• Kal Bhairav Mandir Darshan." },
      {
        day: "Day 2",
        activity: "• Breakfast at a recommended restaurant (Self-Paid).",
      },
      { day: "Day 2", activity: "• Boat Ride on the Ganges." },
      { day: "Day 2", activity: "• Visit Sankat Mochan Hanuman Temple." },
      { day: "Day 2", activity: "• Free Time for Shopping / Sightseeing." },
      {
        day: "Day 2",
        activity: "• Witness Ganga Aarti at Dashashwamedh Ghat.",
      },
      {
        day: "Day 2",
  ...
  "prayagraj-ayodhya": {
    ...
    routeOverview: ["Day 1:Prayagraj Arrival, Darshan & Stay.","Day 2: Ayodhya Darshan"],
    highlights: [
      "Hassle-free spiritual experience with expert travel assistance",
      "Comfortable hotel stay in Prayagraj with complimentary breakfast",
      "Customizable itinerary to suit your needs",
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "• Late-Night Departure for Ayodhya (Overnight Journey).",
      },

      { day: "Day 2", activity: "• Early Morning Arrival in Ayodhya" },
      { day: "Day 2", activity: "• Sacred Sarayu Snan." },
      {
        day: "Day 2",
        activity: "• Breakfast at a recommended restaurant (Self-Paid).",
      },
      { day: "Day 2", activity: "• Hanuman Garhi Temple Darshan." },
      { day: "Day 2", activity: "• Shri Ram Janmabhoomi Temple Darshan." },
      {
        day: "Day 2",
        activity: "• Lunch Break at a recommended restaurant (Self-Paid).",
      },
      { day: "Day 2", activity: "• Kanak Bhavan Temple Visit." },
      { day: "Day 2", activity: "• Dasarath Mahal Visit." },
      { day: "Day 2", activity: "• Saryu Ghat & Evening Aarti." },
      {
        day: "Day 2",
        activity: "• Return Journey to Prayagraj (Late Night Arrival).",
      },
  ...
  "prayagraj-vindhyachal": {
    ...
    images: [
      "/images/touritinerary/Prayagraj-Vindhyachal/pv6.jpg",
    ...
    routeOverview: ["Day 1: Prayagraj Arrival, Darshan & Stay.", "Day 2:  Vindhyanchal Darshan and Departure."],
    highlights: [
      "Hassle-free spiritual experience with expert travel assistance.",
      "Comfortable hotel stay in Prayagraj with complimentary breakfast",
      "Customizable itinerary to suit your needs",
    ...
    itinerary: [
      ...
      { day: "Day 1", activity: "• Back to Hotel – Overnight Stay." },

      { day: "Day 2", activity: "• Breakfast at Hotel & Checkout" },
      {
        day: "Day 2",
        activity: "• Nag Vasuki Temple & Mankameshwar Temple Darshan.",
      },
      {
        day: "Day 2",
        activity: "• Lunch Break at a recommended restaurant (Self-Paid).",
      ...
      { day: "Day 2", activity: "• Visit to Maa Ashtabhuja Temple." },
      { day: "Day 2", activity: "• Vindhyavasini Mata Darshan." },
      {
        day: "Day 2",
        activity: "• Dinner at a recommended restaurant (Self-Paid).",
      },
  ...
  "prayagraj-ayodhya-varanasi": {
    ...
    images: [
      "/images/touritinerary/Prayagraj-Varanasi-Ayodhya/pav7.jpg",
    ...
    routeOverview: [
      ...
      "Day 3: Varanasi Darshan & Departure.",
    ],
    highlights: [
      "Comfortable AC travel with an experienced driver who knows the pilgrimage routes",
      "Well-rated hotel stays with complimentary breakfast at all locations",
      "Special care for families and elderly devotees for a stress-free journey",
      "Customizable itinerary – Personalize your experience!",
      "Pay on arrival – No advance payment required",
      "Travel booking assistance available from anywhere in India",
      "Get the best train/flight options absolutely free!",
      "Want us to handle your travel? Let’s plan it together!",
    ],
    itinerary: [
      { day: "Day 1", activity: "• Morning Arrival & Briefing" },
      {
        day: "Day 1",
        activity:
          "• Pickup Assistance (Optional, Chargeable) – Pickup from Prayagraj Airport/Railway Station and transfer to the branch office for briefing and customization options.",
      },
      {
        day: "Day 1",
        activity:
      ...
      },
      {
        day: "Day 1",
        activity:
          "• Triveni Sangam Snan & Boat Ride – Holy dip at the confluence of Ganga, Yamuna, and Saraswati with an included boat ride.",
      },
      {
        day: "Day 1",
        activity:
          "• Bade Hanuman Ji Temple Darshan – Visit this unique temple known for its reclining idol of Lord Hanuman.",
      },
      {
        day: "Day 1",
        activity:
          "• Shankar Viman Mandapam – Explore this beautifully crafted South Indian-style temple.",
      },
      {
        day: "Day 1",
        activity:
          "• Lunch Break (Self-Paid) – Enjoy a vegetarian meal at a recommended restaurant.",
      },
      {
        day: "Day 1",
        activity:
          "• Alopi Devi Shakti Peeth Darshan – Visit this sacred Shakti Peeth.",
      },
      {
        day: "Day 1",
        activity:
          "• Nag Vasuki Temple Visit – Seek blessings at the temple dedicated to Lord Vasuki.",
      },
      { day: "Day 1", activity: "• Free Time for Shopping & Exploration." },
      {
        day: "Day 1",
        activity: "• Dinner (Self-Paid) at a recommended restaurant.",
      },
      {
        day: "Day 1",
        activity: "• Departure for Ayodhya (Overnight Journey).",
      },

      { day: "Day 2", activity: "• Early Morning Arrival in Ayodhya" },
      {
        day: "Day 2",
        activity: "• Hotel Check-in & Complimentary Breakfast.",
      },
      {
        day: "Day 2",
        activity: "• Sarayu Snan – Holy dip in the sacred Sarayu River.",
      },
      {
        day: "Day 2",
        activity:
          "• Hanuman Garhi Darshan – Seek blessings at this iconic temple.",
      },
      {
        day: "Day 2",
        activity:
          "• Shri Ram Janmabhoomi Darshan – Visit Lord Ram’s birthplace.",
      },
      {
        day: "Day 2",
        activity:
          "• Lunch Break (Self-Paid) – Authentic vegetarian meal at a trusted restaurant.",
      },
      {
        day: "Day 2",
        activity:
          "• Kanak Bhavan Visit – Explore this beautiful temple gifted to Goddess Sita.",
      },
      {
        day: "Day 2",
        activity:
          "• Dasharath Mahal Visit – Discover the historical palace of King Dasharath.",
      },
      {
        day: "Day 2",
        activity:
          "• Sarayu Aarti – Witness the mesmerizing evening aarti by the river.",
      },
      {
        day: "Day 2",
        activity: "• Departure for Varanasi (Overnight Journey).",
      },

      {
        day: "Day 3",
        activity: "• Morning Arrival in Varanasi & Hotel Check-in",
      },
      { day: "Day 3", activity: "• Complimentary Breakfast." },
      {
        day: "Day 3",
        activity:
          "• Ganga Snan at Dashashwamedh Ghat – Holy dip in the sacred Ganga.",
      },
      {
        day: "Day 3",
        activity:
          "• Kashi Vishwanath Jyotirlinga Darshan – Seek blessings at this revered Shiva shrine.",
      },
      {
        day: "Day 3",
        activity:
      ...
      },
      {
        day: "Day 3",
        activity:
          "• Kal Bhairav Temple Visit – Pay homage to the fierce guardian deity of Kashi.",
      },
      {
        day: "Day 3",
        activity:
          "• Boat Ride on the Ganges – Experience the ghats from a serene boat ride.",
      },
      {
        day: "Day 3",
        activity:
          "• Lunch Break (Self-Paid) – Traditional Banarasi meal at a recommended restaurant.",
      },
      {
        day: "Day 3",
        activity:
          "• Sankat Mochan Hanuman Temple Darshan – Visit this powerful Hanuman temple.",
      },
      {
        day: "Day 3",
        activity:
          "• Free Time for Shopping – Explore Banarasi silk sarees, rudraksha malas, and souvenirs.",
      },
      {
        day: "Day 3",
        activity:
          "• Ganga Aarti at Dashashwamedh Ghat – Witness the breathtaking evening Aarti.",
      },
      {
        day: "Day 3",
        activity:
  ...
  "prayagraj-vindhyachal-ayodhya": {
    ...
    images: [
      ...
      "/images/touritinerary/Prayagraj-Vindhyachal-Ayodhya/pva3.jpg",
    ...
    itinerary: [
      { day: "Day 1", activity: "• Morning Arrival & Briefing" },
      {
        day: "Day 1",
        activity:
          "• Pickup Assistance (Optional, Chargeable) – Pickup from Prayagraj and transfer to the branch office for briefing and customization options.",
      },
      {
        day: "Day 1",
        activity:
      ...
      { day: "Day 1", activity: "• Overnight Stay in Prayagraj." },

      {
        day: "Day 2",
        activity: "• Morning in Prayagraj & Departure for Vindhyanchal",
      },
      {
        day: "Day 2",
        activity: "• Complimentary Breakfast & Hotel Checkout.",
      },
      {
        day: "Day 2",
        activity: "• Drive to Vindhyanchal – Arrive by afternoon.",
      },
      {
        day: "Day 2",
        activity:
      ...
      { day: "Day 2", activity: "• Dinner Break (Self-Paid)." },
      {
        day: "Day 2",
        activity:
          "• Evening Departure for Ayodhya – Reach by late night and check-in to hotel.",
      },
      { day: "Day 2", activity: "• Overnight Stay in Ayodhya." },

      { day: "Day 3", activity: "• Ayodhya – The Abode of Divinity" },
      {
        day: "Day 3",
        activity: "• Complimentary Breakfast & Refreshing Start.",
      },
      {
        day: "Day 3",
        activity: "• Sarayu Snan – Holy dip in the sacred Sarayu River.",
  ...
  "prayagraj-vindhyachal-varanasi": {
    ...
    routeOverview: [
      "Day 1: Prayagraj Arrival, Darshan & Stay.",
      "Day 2:  Vindhyanchal Darshan and Departure to Varanasi.",
      "Day 3: Varanasi Darshan & Departure.",
    ],
    highlights: [
      "Comfortable AC travel with an experienced driver who knows the pilgrimage routes",
    ...
    itinerary: [
      ...
      {
        day: "Day 2",
        activity: "• Optional Shopping Time for Religious Items & Prasad.",
      },
      { day: "Day 2", activity: "• Dinner Break (Self-Paid)." },
      {
        day: "Day 2",
        activity:
          "• Evening Departure for Kashi (Varanasi) – Reach by late night and check-in to hotel.",
      },
      { day: "Day 2", activity: "• Overnight Stay in Varanasi." },

      { day: "Day 3", activity: "• Kashi – The Spiritual Capital" },
      {
        day: "Day 3",
        activity: "• Ganga Snan at Assi Ghat or Dashashwamedh Ghat.",
      },
      {
        day: "Day 3",
        activity:
          "• Darshan at Kashi Vishwanath Temple (One of the 12 Jyotirlingas).",
      },
      {
        day: "Day 3",
        activity: "• Annapurna Devi Temple Darshan (Goddess of nourishment).",
      },
      {
        day: "Day 3",
        activity: "• Kal Bhairav Temple Visit (Guardian deity of Kashi).",
      },
      {
        day: "Day 3",
        activity:
      ...
      { day: "Day 3", activity: "• Lunch Break (Self-Paid)." },
      {
        day: "Day 3",
        activity:
          "• Sankat Mochan Hanuman Temple Visit – A revered Hanuman Ji temple.",
      },
      {
        day: "Day 3",
        activity:
          "• Ganga Aarti at Dashashwamedh Ghat – A mesmerizing spiritual experience.",
      },
      {
        day: "Day 3",
        activity:
