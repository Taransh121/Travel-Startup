...
export const poojaItineraries : Record<string, Pooja> ={
  "navgrah-shanti-path-at-prayagraj": {
    ...
    imageUrl: "/images/poojaItinerary/Nav grah Shanti path at prayagraj_Vindhyanchal_.jpg",
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          { title: "Arrival & Check-in", content: "Assistance with travel and accommodation arrangements." },
          { title: "Sankalp (Vow-Taking Ceremony)", content: "Personalized Sankalp with your name, gotra, and planetary doshas." },
          { title: "Nav Grah Abhishek", content: "Ritualistic offerings for each of the nine planets." },
          { title: "Nav Grah Mantra Jaap", content: "Vedic chanting to pacify planetary influences." },
          { title: "Havan (Fire Ritual)", content: "Nine separate havans for each planet." },
          { title: "Aarti & Prasadam Distribution", content: "Concluding the ritual with divine blessings." },
          { title: "Drop-off Assistance", content: "Assistance available for yatris after pooja completion." },
        ],
      },
      {
        title: "Pooja Options",
        ...
        subsections: [
          {
            ...
            content: "It is performed to remove planetary doshas, balance astrological influences, and bring stability, prosperity, and well-being.",
          },
          {
            title: "How does the Virtual Pooja work?",
            content: "You will receive a private live stream link to join the pooja from anywhere. You can also interact with the purohits during key rituals.",
          },
          {
            title: "What if I need accommodation in Prayagraj?",
            content: "We provide customized accommodation assistance for all budgets – from dharamshalas to premium hotels.",
          },
          {
            title: "What if I want prasad delivered after the Virtual Pooja?",
            content: "We can arrange prasad delivery to your home upon request. Courier charges will be extra as per location.",
          },
        ],
      },
    ],  
  ...
  "mahamrityunjay-jaap-at-prayagraj": {
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          { title: "Arrival & Check-in", content: "Assistance with travel and accommodation arrangements." },
          { title: "Sankalp (Vow-Taking Ceremony)", content: "Personalized Sankalp with your name, gotra, and wishes." },
          { title: "Mahamrityunjay Mantra Jaap", content: "Continuous chanting of the sacred Mahamrityunjay Mantra for the chosen duration." },
          { title: "Rudrabhishek", content: "Abhishek with holy water, milk, honey, and other sacred offerings to Lord Shiva." },
          { title: "Havan (Fire Ritual)", content: "Offering of sacred materials into the fire for divine blessings." },
          { title: "Aarti & Prasadam Distribution", content: "Concluding the ritual with divine blessings." },
          { title: "Drop-off Assistance", content: "Assistance available for yatris after pooja completion." },
        ],
      },
      ...
      },
      {
        ...
        subsections: [
          ...
          {
            title: "What if I want prasad delivered after the Virtual Pooja?",
            content: "We can arrange prasad delivery to your home upon request.",
          },
        ],
      },
      {
    ...
    sections: [
        ...
        },
        {
          ...
          subsections: [
            ...
            {
              title: "What if I want prasad or pooja items delivered after the Virtual Pooja?",
              content: "Prasad & pooja items home delivery is NOT included in the package price. However, it can be arranged upon request, and additional courier charges will apply based on the customer’s location.",
            },
            {
              title: "Is accommodation included in the package?",
              content: "No, accommodation is not included in the package price. However, we can arrange it separately based on your preference at an additional cost.",
            },
          ],
        },
      ],
      ...
      sections: [
        ...
        },
        {
          ...
          subsections: [
            ...
            {
              title: "Can I book the pooja for any other day apart from the suggested auspicious days?",
              content:
          ...
          subsections: [
            {
              ...
              content: "The pooja lasts for 7 days and includes various sacred rituals.",
              bulletPoints: [
            ...
            },
            {
              ...
              bulletPoints: ["Navratri (Best Time)", "Purnima", "Amavasya", "Any Auspicious Day"],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          subsections: [
            ...
            },
            {
              ...
              bulletPoints2: ["Optional: Prasad Delivery", "Bonus: Free consultation with our Purohit after the Pooja!"],
            },
          ],
        },
        {
      ...
      sections: [
        {
          title: "Introduction",
          content:
            "The Rudri Path is a powerful recitation of Shri Rudram from the Yajurveda, dedicated to Lord Shiva. It is one of the most effective Vedic prayers for spiritual benefits.",
          subsections: [
            {
              title: "What Is Rudri Path?",
              content:
                "The Rudri Path is a Vedic recitation performed to seek Lord Shiva's blessings for various aspects of life.",
              bulletPoints: [
                "Good health & well-being",
                "Success in career & personal life",
                "Protection from negativity & evil forces",
                "Removal of doshas & bad karma",
                "Inner peace, mental clarity & spiritual growth",
              ],
            },
            {
              title: "Where Can You Perform Rudri Path?",
              content:
                "You can perform the Rudri Path at your home, temple, or even join online via live streaming.",
            },
          ],
        },
        {
          ...
          subsections: [
            {
              title: "Pooja Duration & Priest",
              content: "The Rudri Path Pooja lasts for 1 day and is conducted by 1 Vedic Priest.",
            },
            {
              title: "Rituals Involved",
              bulletPoints: [
                "Ganesha Puja & Sankalp",
                "Kalash Sthapana & Navagraha Shanti",
                "Shri Rudram Path (Complete Recitation of Rudri)",
                "Abhishek of Shivling with Milk, Ghee, Panchamrit & Water",
                "Offering of Bilva Patra, Flowers & Akshat",
                "Maha Aarti & Prasad Distribution",
              ],
            },
            {
              title: "Best Days for the Pooja",
              bulletPoints: [
                "Mondays",
                "Pradosh Vrat",
                "Maha Shivratri",
        ...
        {
          title: "Key Benefits of Rudri Path",
          bulletPoints: [
            "Removes negative energies & obstacles",
            "Boosts health, wealth & happiness",
            "Brings peace, mental strength & harmony",
            "Ensures divine protection from misfortunes",
            "Ideal for spiritual upliftment & success",
          ],
        },
        {
          title: "Pooja Options",
          subsections: [
            {
              title: "In-Person Rudri Path",
              content:
                "The In-Person Rudri Path is performed at your home or temple by a qualified priest.",
              bulletPoints: [
                "Pooja performed at your home or temple",
                "Personalized Sankalp (Your Name, Gotra & Wish)",
                "Complete Rudri Path & Shiv Abhishek",
                "Prasad & Rudraksha Blessings",
                "Optional: Additional havan for deeper spiritual benefits",
              ],
            },
            {
              title: "Online Rudri Path (Live Pooja)",
              content:
                "Join the Rudri Path remotely with a live stream, and get a personalized experience.",
              bulletPoints: [
                "Live Streaming via Zoom/WhatsApp",
                "Dedicated Purohit chanting Rudri Path for you",
                "Personalized Sankalp & Name in Pooja",
                "Receive Prasad & Rudraksha at home",
              ],
            },
          ],
        },
        {
          title: "How to Book the Pooja",
          bulletPoints: [
            "Click the 'Book Now on WhatsApp' button.",
            "Choose In-Person or Virtual Rudri Path.",
            "Share your preferred date & additional requirements.",
            "Get a customized pooja plan.",
        ...
        },
        {
          ...
          subsections: [
            {
              title: "Who should perform Rudri Path?",
              content:
                "This pooja is for anyone seeking Lord Shiva’s blessings for health, peace, and prosperity.",
            },
            {
              title: "Can I customize the Pooja?",
              content:
                "Yes! You can add additional havan, special mantras, or multiple pandits to personalize the pooja.",
            },
            {
              title: "How does the Virtual Pooja work?",
              content:
                "You will receive a private live stream link and can participate in real-time from anywhere in the world.",
            },
            {
              title: "Can I get Prasad after Virtual Pooja?",
              content:
                "Yes! We can deliver Prasad & a sacred Rudraksha to your home after the virtual pooja.",
            },
          ],
        },
      ],
    ...
    sections: [
      {
        title: "Introduction",
        content:
          "The Rudri Path is the chanting of Shri Rudram from the Yajurveda, dedicated to Lord Shiva. Performing 11 Rudri Paths with 5 Purohits amplifies the spiritual energy, bringing immense blessings.",
        subsections: [
          {
            title: "What is 11 Rudri Path?",
            content:
              "The 11 Rudri Path involves chanting Shri Rudram 11 times, with 5 Vedic priests, to intensify the blessings received from Lord Shiva.",
          },
          {
            title: "Benefits of Performing 11 Rudri Path",
            bulletPoints: [
              "Health, longevity & protection from diseases",
              "Wealth, prosperity & business success",
              "Removal of negative energies, doshas & obstacles",
              "Peace, happiness & spiritual growth",
              "Divine grace & fulfillment of wishes",
            ],
          },
          {
            title: "Where Can You Perform This Pooja?",
            content:
              "You can perform the 11 Rudri Path at your home, temple, or even join the pooja online through live streaming.",
          },
        ],
      },
      {
        ...
        subsections: [
          {
            title: "Pooja Duration & Priests",
            content: "The 11 Rudri Path Pooja is performed in 1 day with 5 expert Vedic priests.",
          },
          {
            title: "Main Rituals",
            bulletPoints: [
              "Ganesha Puja & Sankalp",
              "Kalash Sthapana & Navagraha Shanti",
              "11 Rudri Path Recitations (By 5 Purohits)",
              "Shiva Abhishek with Panchamrit, Milk & Water",
              "Offering of Bilva Patra, Flowers & Akshat",
              "Maha Aarti & Prasad Distribution",
            ],
          },
      ...
      {
        title: "Key Benefits of 11 Rudri Path",
        bulletPoints: [
          "Strengthens health & immunity",
          "Ensures financial stability & career growth",
          "Eliminates negative energies & karmic obstacles",
          "Grants divine protection from misfortunes",
          "Brings inner peace, success & harmony",
        ],
      },
      {
        title: "Pooja Experience Options",
        subsections: [
          {
            title: "In-Person 11 Rudri Path",
            content:
              "The in-person 11 Rudri Path is performed at your home or temple by 5 expert Vedic priests.",
            bulletPoints: [
              "5 Purohits chanting 11 Rudri Paths for amplified benefits",
              "Personalized Sankalp (Your Name, Gotra & Wish)",
              "Complete Shiv Abhishek & Maha Aarti",
              "Prasad & Rudraksha Blessings",
              "Optional: Additional havan for deeper spiritual impact",
            ],
          },
          {
            title: "Online 11 Rudri Path",
            content:
              "Join the pooja remotely from anywhere in the world via live streaming.",
            bulletPoints: [
              "Live Streaming via Zoom/WhatsApp",
              "Dedicated 5 Purohits chanting for you",
              "Personalized Sankalp & Name in Pooja",
              "Receive Prasad & Rudraksha at home",
            ],
          },
        ...
        subsections: [
          {
            title: "In-Person Package",
            bulletPoints: [
              "5 Expert Purohits performing 11 Rudri Paths",
              "Shiva Abhishek & Maha Rudram Chanting",
              "Bilva Patra, Panchamrit & Prasad Offerings",
              "Personalized Sankalp & Blessings",
              "Optional: Additional havan & special offerings",
            ],
          },
          {
            ...
            bulletPoints: [
              "Live Streaming from a sacred location",
              "Dedicated Purohits for Your Sankalp",
              "Pooja Recording Available on Request",
              "Optional: Prasad & Rudraksha Delivery",
      ...
      },
      {
        ...
        bulletPoints: [
          "Click the 'Book Now on WhatsApp' button.",
          "Choose In-Person or Virtual 11 Rudri Path.",
          "Share your preferred date & additional requirements.",
          "Get a customized pooja plan.",
          "Confirm your booking & receive details.",
        ],
      },
      {
        ...
        subsections: [
          {
            title: "Who should perform 11 Rudri Path?",
            content:
              "This pooja is recommended for families, businesses, and individuals seeking Lord Shiva’s blessings for prosperity, health, and protection.",
          },
          {
            title: "Can I customize the Pooja?",
            content:
              "Yes! You can add additional havan, special mantras, or more purohits to make the pooja more personalized.",
          },
          {
            title: "How does the Virtual Pooja work?",
            content:
    ...
    "sections": [
      {
        ...
        "content": "Maa Baglamukhi is the 8th Mahavidya and the Goddess of stambhan (paralysis of enemies), victory, and protection. She grants powerful defense against legal issues, enemy attacks, black magic, and negative energies.",
        "subsections": [
          {
          ...
          },
          {
            ...
            "content": "This pooja is recommended for individuals facing serious challenges like business losses, career hurdles, or enemy-related problems."
          }
        ]
      },
      {
        ...
        "subsections": [
          {
            "title": "Duration and Rituals",
            "content": "The pooja lasts for 7 days and involves chanting 1,25,000 Baglamukhi Beej Mantras, followed by a grand Havan on the final day.",
            "bulletPoints": [
              "Duration: 7 Days",
        ...
        "subsections": [
          {
            ...
            "content": "Perform the pooja in Prayagraj at a Shakti Peetha or temple with 9 Pandits chanting for 7 days. Experience a deep spiritual connection with Maa Baglamukhi.",
            "bulletPoints": [
              "9 Pandits chanting for 7 days",
          ...
          },
          {
            ...
            "content": "Join the pooja virtually from anywhere in the world, with HD live streaming of all 7 days of pooja and the final Baglamukhi Havan.",
            "bulletPoints": [
              "Full HD Live Streaming of all 7 days of pooja",
              "Your name & sankalp included in chanting",
        ...
        "subsections": [
          {
            ...
            "content": "This pooja is highly beneficial for those facing legal issues, business losses, enemy problems, or black magic attacks."
          },
          {
            "title": "Can I Customize the Pooja?",
            "content": "Yes! Based on your Kundali, we can adjust the Jaap count and Havan offerings."
          },
          {
            "title": "How Does the Virtual Pooja Work?",
            "content": "You will receive a private live stream link to join the pooja from anywhere. You can also interact with the purohits during key rituals."
          },
          {
            ...
            "content": "Yes! We can arrange Prasad delivery to your home upon request (courier charges will be applicable as per your location)."
          }
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        content: "Laghu Mritunjay Pooja is a powerful 5-day ritual dedicated to Lord Shiva’s Mahamrityunjaya form. It is performed to overcome serious health issues, ward off negative energies, and bless devotees with longevity and spiritual healing.",
        subsections: [
          {
            title: "Significance of the Pooja",
            content: "This pooja involves the Mahamrityunjaya Mantra Jaap & Havan, performed by 7 expert purohits to maximize divine blessings for the participants.",
          },
          {
            title: "Who Should Perform This Pooja?",
            content: "Devotees seeking protection from untimely death, chronic illnesses, negative energies, or those desiring spiritual healing and longevity should consider performing this pooja.",
          }
        ]
      },
      {
      ...
      },
      {
        ...
        subsections: [
          {
            title: "In-Person",
            content: "Performed at a sacred temple/ghat in Prayagraj with 7 experienced purohits for 5 days. The pooja includes Mahamrityunjaya Mantra Jaap & Havan for divine protection. Accommodation can be arranged based on preference.",
            bulletPoints: [
          ...
          {
            title: "Virtual",
            content: "Live streaming of the complete 5-day pooja from Prayagraj. Participate remotely in chanting & havan. Prasad & Rudraksha Mala delivery can be arranged upon request.",
            bulletPoints: [
      ...
      },
      {
        ...
        subsections: [
          {
            title: "In-Person",
            content: "The in-person pooja includes all necessary sacred items and a personalized Sankalp for the devotees. Travel assistance and optional accommodation arrangements are provided.",
            bulletPoints: [
          ...
          {
            title: "Virtual",
            content: "The virtual pooja includes live streaming, interaction with the purohits, and optional prasad & Rudraksha Mala delivery. A recording of the pooja can be provided upon request.",
            bulletPoints: [
        ...
        subsections: [
          {
            ...
            content: "We offer guidance on the best routes, timings, and fares for your journey to Prayagraj. We can also assist with train or flight bookings if required."
          },
          {
            title: "Booking Assistance",
            content: "Train and flight ticket booking is available on request. Booking charges will apply for ticket reservations."
          }
        ]
      },
      {
        ...
        subsections: [
          {
            ...
            content: "Laghu Mritunjay Pooja is performed to seek divine healing, longevity, and protection from untimely death, accidents, and severe health issues."
          },
          {
            title: "Can I customize the Laghu Mritunjay Pooja?",
            content: "Yes! Our purohits will personalize the rituals based on your specific health concerns."
          },
          {
            title: "How does the Virtual Pooja work?",
            content: "You will receive a private live stream link to join the pooja from anywhere. You can also interact with the purohits during key rituals."
          ...
          {
            title: "What if I want prasad & Rudraksha Mala delivered after the Virtual Pooja?",
            content: "We can arrange prasad & Rudraksha Mala delivery to your home upon request (chargeable as per your location)."
          }
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        content: "Nav Chandi Pooja is a highly auspicious and powerful 9-day ritual dedicated to Maa Durga and her nine divine forms (Nava Durga). This grand yagya includes 108 Path of Durga Saptashati and is conducted by 11 expert purohits to bring divine protection, prosperity, and fulfillment of wishes.",
        subsections: [
          {
            title: "Significance of Nav Chandi Pooja",
            content: "The Nav Chandi Pooja invokes the divine blessings of Maa Durga and her nine forms to bring protection, prosperity, and spiritual growth.",
          },
          {
            title: "Who Should Perform This Pooja?",
            content: "This pooja is highly beneficial for those seeking success, prosperity, health, wealth, and spiritual growth, and those who wish to overcome obstacles and negative energies.",
          }
        ]
      },
      {
      ...
      },
      {
        ...
        subsections: [
          {
            title: "In-Person",
            content: "Performed at a sacred temple/ghat in Prayagraj with 11 expert purohits over 9 days. The pooja includes 108 Path of Durga Saptashati for maximum divine blessings. Accommodation and meals can be arranged as per your preference.",
            bulletPoints: [
          ...
          {
            title: "Virtual",
            content: "Live streaming of the complete 9-day pooja from Prayagraj. Participate remotely in chanting & havan. Prasad delivery can be arranged upon request.",
            bulletPoints: [
              "Full HD Live Streaming",
              "Dedicated purohit performing Sankalp",
              "Live participation in chanting & havan via Zoom/WhatsApp",
      ...
      },
      {
        ...
        subsections: [
          {
            title: "In-Person",
            content: "The in-person pooja includes all necessary sacred items, personalized Sankalp, and assistance with travel and accommodation arrangements.",
            bulletPoints: [
          ...
          {
            title: "Virtual",
            content: "The virtual pooja includes full HD live streaming, interaction with the purohits, and optional prasad delivery.",
            bulletPoints: [
              "Full HD streaming from Prayagraj",
              "Live participation in chanting & havan via Zoom/WhatsApp",
              "Prasad home delivery (upon request)",
        ...
        subsections: [
          {
            ...
            content: "Nav Chandi Pooja is performed to invoke the nine divine forms of Maa Durga for protection, success, wealth, and spiritual upliftment."
          },
          {
            title: "Can I customize the Nav Chandi Pooja?",
            content: "Yes! Our purohits will personalize the rituals based on your specific needs."
          },
          {
            title: "How does the Virtual Pooja work?",
            content: "You will receive a private live stream link to join the pooja from anywhere. You can also interact with the purohits during key rituals."
          ...
          {
            title: "What if I want prasad delivered after the Virtual Pooja?",
            content: "We can arrange prasad delivery to your home upon request (chargeable as per your location)."
          }
        ]
      }
    ]
  ...
  "mundan-sanskar-at-vindhyachal" : {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "The Mundan Sanskar is performed at the sacred Maa Vindhyavasini Temple in Vindhyachal, Uttar Pradesh. The ritual is usually performed for children between 1-3 years of age, or as per family tradition.",
        subsections: [
          {
      ...
      },
      {
        ...
        subsections: [
          {
            title: "In-Person",
            content: "The ritual can be performed at the Maa Vindhyavasini Temple in Vindhyachal with personalized Sankalp and blessings from expert purohits.",
            bulletPoints: [
          ...
          },
          {
            ...
            content: "For families unable to travel, virtual assistance is available, offering live guidance and customized rituals performed remotely.",
            bulletPoints: [
        ...
        subsections: [
          {
            ...
            content: "We provide free recommendations for the best routes, timings, and accommodations for families traveling to Vindhyachal."
          },
          {
            title: "Booking",
            content: "We offer train/flight ticket booking services for families traveling to Vindhyachal. Booking charges may apply."
          }
        ]
      },
      {
        ...
        subsections: [
          {
            ...
            content: "It is traditionally performed when the child is between 1-3 years old, but can also be done as per family tradition."
          },
          {
            title: "Can we choose an auspicious date for the Mundan Sanskar?",
            content: "Yes! Our purohits will help you select the best date based on your child’s birth chart."
          },
          {
            title: "Can we customize the Mundan Sanskar rituals?",
            content: "Yes, additional poojas like Navgrah Shanti Pooja can be included upon request."
          },
          {
            title: "Is accommodation available for families traveling to Vindhyachal?",
            content: "Yes, we can assist in arranging comfortable stays near the temple."
          },
          {
            title: "Can I get prasad delivered if I opt for the Virtual Assistance?",
            content: "Yes, we can arrange for Prasad & blessings to be delivered to your home upon request."
          }
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        content: "Satyanarayan Katha is a sacred Hindu ritual dedicated to Lord Vishnu, performed to seek his divine blessings for prosperity, financial stability, family harmony, success, and protection from hardships.",
        bulletPoints: [
        ...
        subsections: [
          {
            ...
            content: "The Satyanarayan Katha Pooja is performed in one day by a Vedic priest, and it includes several sacred rituals.",
            bulletPoints: [
              "Duration: 1 Day",
        ...
        subsections: [
          {
            ...
            content: "Performed at your home or temple, this pooja allows you to experience the ritual in person.",
            bulletPoints: [
          ...
          },
          {
            ...
            content: "Join the pooja remotely and receive live guidance from a dedicated purohit.",
            bulletPoints: [
              "Live Streaming via Zoom/WhatsApp",
              "Dedicated Purohit chanting for you",
              "Personalized Sankalp & Name in Pooja",
      ...
      {
        title: "Booking Steps",
        content: "Follow these easy steps to book your Satyanarayan Katha Pooja.",
        bulletPoints: [
          "Click the 'Book Now on WhatsApp' button.",
        ...
        subsections: [
          {
            ...
            content: "Anyone seeking prosperity, success, family happiness, and divine blessings can perform this pooja."
          },
          {
            title: "Can I customize the Pooja?",
            content: "Yes! You can add havan, extra offerings, or additional purohits."
          },
          {
            title: "How does the Virtual Pooja work?",
            content: "You will receive a private live stream link and can participate in real-time."
          },
          {
            title: "Can I get Prasad after Virtual Pooja?",
    ...
    sections: [
      {
        ...
        content: "Kaal Sarp Dosh occurs when all planets in a horoscope are trapped between Rahu and Ketu. This planetary alignment causes struggles in career, financial instability, health issues, delayed marriage, and unexpected obstacles.",
        subsections: [
          {
      ...
      {
        title: "Pooja Details",
        content: "The Kaal Sarp Dosh Nivaran Pooja is a 1-day special ritual conducted by 10 Vedic Pandits at Naag Vasuki Temple, Prayagraj.",
        subsections: [
          {
            title: "Main Rituals",
            bulletPoints: [
        ...
        subsections: [
          {
            ...
            content: "Join us in Prayagraj for a full-day ritual with 10 expert Vedic Pandits.",
            bulletPoints: [
        ...
        subsections: [
          {
            ...
            content: "Complete Kaal Sarp Dosh Nivaran rituals at Naag Vasuki Temple, Prayagraj.",
            bulletPoints: [
      ...
      },
      {
        ...
        subsections: [
          {
            title: "Who should perform this Pooja?",
            content: "This pooja is highly beneficial for those facing Kaal Sarp Dosh effects like career struggles, delayed marriage, financial instability, or constant obstacles in life."
          },
          {
            title: "Can I customize the Pooja for my specific needs?",
            content: "Yes! Based on your Kundali, we can adjust the Jaap count and special havan rituals."
          },
          {
            title: "How does the Virtual Pooja work?",
            content: "You will receive a private live stream link to join the pooja from anywhere. You can also interact with the purohits during key rituals."
