...
const LiveDarshanPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fef9f5]"> {/* Light Orange Background */}
      {/* Navigation */}
      ...
      <div className="flex justify-center px-4 mb-6">
        ...
        />
        <button
          className={`px-4 py-2 ${searchTerm ? "bg-[#ec8014] hover:bg-[#de7733]" : "bg-gray-400"} text-white rounded-r-md transition`}
          disabled={!searchTerm} 
